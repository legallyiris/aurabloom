...
CREATE TABLE `__new_sessions` (
	...
	`createdAt` integer DEFAULT 1741728479 NOT NULL,
	`userAgent` text,
	`ipAddress` text,
...
CREATE TABLE `__new_communities` (
	`id` text PRIMARY KEY DEFAULT 'tz82raR54ZeL792INQPwJ' NOT NULL,
...
CREATE TABLE `__new_communityMembers` (
	...
	`aboutMe` text(500),
	`joinedAt` integer DEFAULT 1741728479 NOT NULL,
	FOREIGN KEY (`userId`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE no action,
...
CREATE TABLE `__new_channels` (
	`id` text PRIMARY KEY DEFAULT 'OBEuEyvHSdjYWk_7NC6BV' NOT NULL,
	`communityId` text NOT NULL,
	`name` text(100) NOT NULL,
	`description` text(500),
...
CREATE TABLE `__new_messages` (
	`id` text PRIMARY KEY DEFAULT 'G9PBJXh6-rtgC0VIrDbQ6' NOT NULL,
...
CREATE TABLE `__new_federatedActivities` (
	`id` text PRIMARY KEY DEFAULT 'Yj_sQ-FXwzHSdIB6rxqjh' NOT NULL,
	`messageId` text,
	`activityId` text NOT NULL,
	`activityType` text NOT NULL,
	`actorId` text,
	`object` text NOT NULL,
	`published` integer DEFAULT 1741728479 NOT NULL,
...
CREATE TABLE `__new_federatedActors` (
	`id` text PRIMARY KEY DEFAULT '_-W-TDh4MQtFauBa2gJSg' NOT NULL,
	`userId` integer,
	`communityId` text,
...
CREATE TABLE `__new_federatedFollows` (
	`id` text PRIMARY KEY DEFAULT 'JIyRnw5khsnA3o40473Dk' NOT NULL,
